...
context('Actions', () => {
  ...
  it('.type() - type into a DOM element', () => {
    ...
    cy.get('.action-email').type('disabled error checking', { force: true });
    cy.get('.action-email').should('have.value', 'disabled error checking');
  });
  ...
  it('.select() - select an option in a <select> element', () => {
    ...
    cy.get('.action-select-multiple').should('deep.equal', [
      'fr-apples',
      'fr-oranges',
      'fr-bananas',
    ]);
